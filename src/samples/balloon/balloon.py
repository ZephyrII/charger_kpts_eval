...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 train.py train --dataset=/path/to/charger/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 train.py train --dataset=/path/to/charger/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 train.py train --dataset=/path/to/charger/dataset --weights=imagenet
...
class ChargerDataset(utils.Dataset):
    ...
    def load_charger(self, dataset_dir, subset):
        ...
        for a in annotations:
            full_a = os.path.join(dataset_dir, a)
            ...
            image_path = os.path.join(dataset_dir, 'images', a)
