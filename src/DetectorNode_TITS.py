...
class DetectorNode:
    ...
    def __init__(self):
        ...
        path_to_model_front = "/root/share/tf/Keras/06_04_tape_heatmap_0.8"  #
    ...
    def start(self):
        ...
        if self.read_from_dir_path is not None:
            ...
            rospy.Subscriber(self.pointgrey_topic, CompressedImage, self.update_pointgrey_image, queue_size=1, buff_size=2**24)
    ...
    def draw_detection(self, frame):
        ...
        # cv2.imwrite('/root/share/tf/out_0.2.jpg', frame)
        # exit(0)
